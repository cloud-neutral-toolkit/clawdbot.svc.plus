...
### Highlights
- Rebrand: rename the npm package/CLI to `openclaw`, keep a `openclaw` compatibility shim, move extensions to the `@openclaw/*` scope, and update openclaw bundle IDs/labels/logging subsystems. Thanks @thewilloftheshadow.
